...
import SOCKET_ACTIONS from './common/constants.js'
...
io.on('connection', async (socket) => {
   ...
   socket.on(SOCKET_ACTIONS.JOIN, async (config) => {
   ...
   socket.on(SOCKET_ACTIONS.LEAVE, async () => await leaveRoom())
